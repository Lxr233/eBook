...
public class BookPlayActivity extends Activity {
	...
	private void registListener() {
		...
		mMenu.setOnTxtMenuClickListener(new TxtMenuClockListener() {// �ײ��˵�ѡ�����
		...
		mTxtTextMenu.setonTxtTextChangeListener(new onTxtTextChangeListener() {// �������ü���
		...
		mProgressMenu.setonProgressChangeListener(new onProgressChangeListener() {// ������ת
